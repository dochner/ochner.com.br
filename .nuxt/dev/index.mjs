import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/douglasochner/projects/studies/ochner.com.br/node_modules/.pnpm/node-fetch-native@1.6.4/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/douglasochner/projects/studies/ochner.com.br/node_modules/.pnpm/h3@1.11.1/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/douglasochner/projects/studies/ochner.com.br/node_modules/.pnpm/vue-bundle-renderer@2.1.0/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import { createCall, createFetch } from 'file:///Users/douglasochner/projects/studies/ochner.com.br/node_modules/.pnpm/unenv@1.9.0/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/douglasochner/projects/studies/ochner.com.br/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/douglasochner/projects/studies/ochner.com.br/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/douglasochner/projects/studies/ochner.com.br/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/douglasochner/projects/studies/ochner.com.br/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/douglasochner/projects/studies/ochner.com.br/node_modules/.pnpm/unstorage@1.10.2_ioredis@5.4.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/douglasochner/projects/studies/ochner.com.br/node_modules/.pnpm/unstorage@1.10.2_ioredis@5.4.1/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/douglasochner/projects/studies/ochner.com.br/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/douglasochner/projects/studies/ochner.com.br/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/douglasochner/projects/studies/ochner.com.br","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/douglasochner/projects/studies/ochner.com.br/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/douglasochner/projects/studies/ochner.com.br/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/douglasochner/projects/studies/ochner.com.br/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/douglasochner/projects/studies/ochner.com.br/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _R1qOvJuYdy = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/douglasochner/projects/studies/ochner.com.br";
...
const _e28GDkV5no = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const getClientManifest = () => import('file:///Users/douglasochner/projects/studies/ochner.com.br/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/douglasochner/projects/studies/ochner.com.br/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
